...
## Introduction
Overview of the project developed during college final year of the Btech. The project is in progress with the collaboration of four members.The objective of the project is to create a platform that enables users to create posts and raise charity funds through them. The system consists of two main components: the admin side and the user side.
